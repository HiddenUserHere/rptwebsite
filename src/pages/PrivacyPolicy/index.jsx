    ...
    <div className="page-content-full download-page">
      ...
      <div className="page-content">
        ...
        <div className="info-text">
          ...
          <p>
            When registering on our site, as appropriate, you will be asked to
            enter your email address or other details to aid in identifying your
            account.
          </p>
          ...
          <p>
            ...
            following ways: to allow us to better service you regarding features
            or in responding to your support requests. to send periodic emails
            regarding your account or other services.
          </p>
          ...
          <p>
            ...
            safe as possible. information stored on the website is encrypted
            using various algorithms. Your personal information is contained
            ...
            when a user registers an account, submits, or accesses their
            information, uses features to maintain the safety of your personal
          ...
          <p>
            by logging in to their account. by contacting us directly via one of
            our contact methods below. Users are able to request the removal of
            their information: by sending us an email. by sending us a support
            ticket.
          </p>
          ...
          <p>
            ...
            place. does our site allow third party behavioral tracking? We do
            not allow third-party behaviour tracking.
          </p>
          {/* prettier-ignore-end */}
        </div>
      </div>
