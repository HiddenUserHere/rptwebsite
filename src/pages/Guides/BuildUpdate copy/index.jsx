...
const BuildUpdate = () => {
  return (
    <SimpleGuide
      ...
      pageDescription={
        <div>
          Character Formulas section is a comprehensive guide to the various
          formulas used in our game. It provides detailed information on how
          various game mechanics, such as damage calculation and character
          stats, are calculated. By understanding these formulas, you&apos;ll be
          able to optimize your character&apos;s build and strategy, ensuring
          that you are always performing at your best. This section is an
          essential resource for serious players looking to master Regnum World
          and become powerful heroes. So take the time to study our formulas
          carefully, and gain an edge over your competition!
        </div>
      }
      guideTitle="Game Formulas and Build Update"
      guideContent={
