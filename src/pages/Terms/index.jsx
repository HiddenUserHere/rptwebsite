    ...
    <div className="page-content-full download-page">
      ...
      <div className="page-content">
        ...
        <div className="info-text">
          ...
          <h1>Terms of Use</h1>
          <p>
            By accessing or using www.regnum.world (the &quot;site&quot;) and
          ...
          <p>
            ...
            by regnum.world. Regnum World reserves the right to refuse service
            in its discretion, without limitation, if Regnum World believes the
            user conduct violates applicable law or is harmful to the interests
            of Regnum World, other users of the site and the services or its
            affiliates.
          </p>

          <h1>Use of Services</h1>
          <p>
            Regnum World reserves all rights in and to the Materials not
            expressly granted herein. Subject to Regnum World&lsquo;s policies
            governing the use of its intellectual property, as applicable, you
            may not: (i) use or transmit any Materials on or to any other Web
            site or network; (ii) modify, translate, reverse engineer,
          ...
          <h1>Distribution</h1>
          <p>
            regnum.world does not support distribution of any game clients.
          ...
          <p>
            Regnum World provides free and unlimited access to the site and the
            services.
          </p>

          <h1>Submission</h1>
          <p>
            Regnum World does not assume any obligation with respect to any
          ...
          <p>
            Neither Regnum World, nor its affiliates, nor any of their
            respective officers, directors, employees, or agents, nor any third
            party, including any provider/affiliate, or any other user of the
            site and services, guarantees the accuracy, completeness, or
            usefulness of any content, nor its merchantability or fitness for
            any particular purpose. in some instances, the content available
            through the site may represent the opinions and judgments of
            providers/affiliates or users. Regnum World and its affiliates do
            not endorse and shall not be responsible for the accuracy or
            reliability of any opinion, advice, or statement made on the site
            and the services by anyone other than authorized Regnum World
            employees. under no circumstances shall Regnum World, or its
            affiliates, or any of their respective officers, directors,
            employees, or agents be liable for any loss, damage or harm caused
            by a user&lsquo;s reliance on information obtained through the site
            and the services. it is the responsibility of the user to evaluate
          ...
          <p>
            ...
            user&lsquo;s sole risk. neither Regnum World, nor its affiliates,
            ...
            are provided by Regnum World on an &quot;as is&quot; and &quot;as
            ...
            particular purpose. Regnum World will not be liable for any damages
            of any kind arising from the use of the site and the services,
            including but not limited to direct, indirect, incidental, punitive
            and consequential damages. under no circumstances shall Regnum World
          ...
          <p>
            Regnum World reserves the right, in its sole discretion, to change,
            suspend, limit, or discontinue any aspect of the service and the
            services at any time. Regnum World may suspend or terminate any
            user&lsquo;s access to all or part of the site and the services,
            without notice, for any conduct that Regnum World, in its sole
          ...
          <p>
            ...
            and the services. Regnum World does not assume any financial
            obligation with respect to payments. the user must be over 18 to be
            eligible to make a payment to Regnum World. Regnum World is not
            liable for any unauthorized payments.
          </p>

          <h1>Acknowledgement</h1>
          <p>
            By accessing or using the site and the services, the user agrees to
            be bound by these terms and conditions, including disclaimers.
            Regnum World reserves the right to make changes to the site and
          ...
          <p>
            ...
            potential illegal activities. Regnum World makes significant effort
            to protect submitted information to prevent unauthorised access to
            that information in its internal procedures and technology. however,
            we do not guarantee, nor should you expect, that your personal
